			...
			<div class="col-md-5">
				<form id='frm'>
				  <div class="form-group">
					<label>User Katagori Barang</label>
					<input type="text" class="form-control" name="name" id='name' required placeholder="katagori">
				  </div>
				  <div class="form-group">
					<label>Nama Barang</label>
					<input type="email" class="form-control" name="email" id='email' required placeholder="Nama">
				  </div>
				  <div class="form-group">
					<label>Jumlah Stok</label>
					<input type="text" class="form-control"  name="mobile" id='mobile' required placeholder="jumlah">
				  </div>
